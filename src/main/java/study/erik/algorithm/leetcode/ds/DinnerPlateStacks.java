...
/**
 * @author yueyi
 * @version : DinnerPlateStacks.java, v 0.1 2023年01月02日 21:51 yueyi Exp $
 */
@LetCodeCommit(title = "1172. Dinner Plate Stacks",
        selfRemark = "不觉得这是一个很好地题目。"
                + "这里用TreeSet来保存可用的stack是很必要的"
                + "不然就会沦为线性遍历")

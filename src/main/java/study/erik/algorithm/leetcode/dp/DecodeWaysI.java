...
//        Assert.assertEquals(0, solutionForHouseRobber1("00"));
//        Assert.assertEquals(1, solutionForHouseRobber1("101"));
//        Assert.assertEquals(1, solutionForHouseRobber1("10"));
//        Assert.assertEquals(2, solutionForHouseRobber1("12"));
//        Assert.assertEquals(3, solutionForHouseRobber1("226"));
    }
}
